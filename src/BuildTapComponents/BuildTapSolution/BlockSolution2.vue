<template>
    ...
    @mouseleave="hoverOut()"
    >
      <build-tap-icon-2 :hoverIc="color"/>
      <div class="box-text">
      <text-solution :hoverFx="isHovering"
      class="text-block"
      SolutionView="Docs"
      SolutionView1="Hệ thống Data Management"
      />
      </div>
...
<script>
import BuildTapIcon2 from "@/components/MyArchive/myicons/BuildTapIcon2.vue";
...
export default {
  ...
  methods: {
    hoverOn() {
      ...
      this.colorLogoBlur = '#ffffff'
    },
    hoverOut() {
      this.color = '#4193F0'
      this.isHovering = false
      this.colorLogoBlur = '#006FED'
    }
  }
};
</script>
