  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log("title news:", this.newsList[4].title);
        console.log("caption news:", this.newsList[4].caption);
        console.log("url img news:", this.newsList[4].thumbnail);
        console.log("url news:", this.newsList[4].url);
      })
      .catch((error) => {
        console.error(error);
      });
