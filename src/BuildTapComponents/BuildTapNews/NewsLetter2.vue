  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log("title news:", this.newsList[1].title);
        console.log("caption news:", this.newsList[1].caption);
        console.log("url img news:", this.newsList[1].thumbnail);
        console.log("url news:", this.newsList[1].url);
      })
      .catch((error) => {
        console.error(error);
      });
