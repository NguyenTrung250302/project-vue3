  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log("title news:", this.newsList[2].title);
        console.log("caption news:", this.newsList[2].caption);
        console.log("url img news:", this.newsList[2].thumbnail);
        console.log("url news:", this.newsList[2].url);
      })
      .catch((error) => {
        console.error(error);
      });
