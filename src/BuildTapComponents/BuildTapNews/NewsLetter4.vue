  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log("title news:", this.newsList[3].title);
        console.log("caption news:", this.newsList[3].caption);
        console.log("url img news:", this.newsList[3].thumbnail);
        console.log("url news:", this.newsList[3].url);
      })
      .catch((error) => {
        console.error(error);
      });
